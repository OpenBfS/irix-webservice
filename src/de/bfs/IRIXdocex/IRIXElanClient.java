...
public class IRIXElanClient {
	...
	public IRIXElanClient(ReportType report)
	{
	...
	private boolean ELANClient()
	{
		...
		try {
            resources = ResourceBundle.getBundle("resources.IRIXElanClient", 
                                                 Locale.getDefault());
        } catch (MissingResourceException mre) {
            System.err.println("resources/IRIXElanClient.properties not found");
            return false;
        }
		...
		ELANService elan = new ELANService("http://"+host+":"+port+"/"+ploneSite,user,pw);
