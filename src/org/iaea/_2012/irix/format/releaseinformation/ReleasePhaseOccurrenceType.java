...
/**
 * <p>Java class for ReleasePhaseOccurrenceType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ReleasePhaseOccurrenceType">
 ...
 * 
 */
@XmlType(name = "ReleasePhaseOccurrenceType")
@XmlEnum
public enum ReleasePhaseOccurrenceType {
    ...
    ReleasePhaseOccurrenceType(String v) {
        value = v;
    }
    ...
    public static ReleasePhaseOccurrenceType fromValue(String v) {
        for (ReleasePhaseOccurrenceType c: ReleasePhaseOccurrenceType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
