...
public class UploadReportTest {
    ...
    public ReportType getReportFromFile(String file) {
        try {
            JAXBContext jaxbContext = JAXBContext.newInstance(
                ReportType.class.getPackage().getName());
    ...
    public void testServiceCreated()
        ...
        Endpoint endpoint = Endpoint.publish(
            "http://localhost:18913/upload-report", testObj);
        ...
        URL wsdlDocumentLocation = new URL(
            "http://localhost:18913/upload-report?wsdl");
        ...
        UploadReportInterface service = serv.getPort(portQN,
            UploadReportInterface.class);
